    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseMicrosoftAccountAuthentication(
                clientId: "2926979237377198",
                clientSecret: "4793c6597f6d5d59ee9c2f2aaff71e24");

            app.UseTwitterAuthentication(
               consumerKey: "2926979237377198",
               consumerSecret: "4793c6597f6d5d59ee9c2f2aaff71e24");

            app.UseFacebookAuthentication(
               appId: "2926979237377198",
               appSecret: "bac41c669f897e86e21af5d6fa3348e0");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "720139446697-u4bfonhol6e29fu16qmnq19ic3nea2pe.apps.googleusercontent.com",
                ClientSecret = "83efs35NjncBD5ngcUWFRtbP"
            });
